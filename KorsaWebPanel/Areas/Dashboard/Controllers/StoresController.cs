...
namespace BasketWebPanel.Areas.Dashboard.Controllers
{
    ...
    public class StoresController : Controller
    {
        ...
        //    if (StoreId.HasValue)
        //    {
        //        var responseStore = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/GetEntityById", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Store, "Id=" + StoreId.Value));
        ...
        //    try
        //    {
        //        var response = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/Admin/DeleteEntity", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Store, "Id=" + StoreId));
        //        if (response is Error)
