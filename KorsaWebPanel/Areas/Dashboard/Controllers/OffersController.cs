...
namespace BasketWebPanel.Areas.Dashboard.Controllers
{
    ...
    public class OffersController : Controller
    {
        ...
        //    if (OfferId.HasValue)
        //    {
        //        var responseProduct = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/GetEntityById", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Offer, "Id=" + OfferId.Value));
        ...
        //    try
        //    {
        //        var response = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/Admin/DeleteEntity", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Offer, "Id=" + OfferId));
        //        if (response is Error)
