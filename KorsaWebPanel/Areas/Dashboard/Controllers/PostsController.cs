...
namespace BasketWebPanel.Areas.Dashboard.Controllers
{
    public class PostsController : Controller
    {
        ...
        //    try
        //    {
        //        var response = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/Admin/DeleteEntity", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Post, "Id=" + PostId));
        //        if (response is Error)
