...
namespace BasketWebPanel.Areas.Dashboard.Controllers
{
    ...
    public class PackageController : Controller
    {
        ...
        //    {
        //        var responseProduct = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/GetEntityById", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Package, "Id=" + PackageId.Value));
        ...
        //    try
        //    {
        //        var response = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/Admin/DeleteEntity", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Package, "Id=" + PackageId));
        //        if (response is Error)
