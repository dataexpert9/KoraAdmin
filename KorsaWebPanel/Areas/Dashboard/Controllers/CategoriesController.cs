...
namespace BasketWebPanel.Areas.Dashboard.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        //        {
        //            var responseProduct = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/GetEntityById", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Category, "Id=" + CategoryId.Value));
        ...
        //    try
        //    {
        //        var response = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/Admin/DeleteEntity", User, null, true, false, null, "EntityType=" + (int)KorsaEntityTypes.Category, "Id=" + CategoryId));
        //        if (response is Error)
